...
function buildTree(paths) {
  ...
  function convert(obj) {
    return Object.values(obj).map((node) => ({
      ...
      path: node.path,
      type: node.type,
      children: node.children ? convert(node.children) : void 0
    }));
  }
  return convert(root2);
}
function FileTree({ owner, repo, onSelect }) {
  ...
  function renderNode(node, depth = 0) {
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      ...
      open.has(node.path) && node.children?.map((child) => renderNode(child, depth + 1))
    ] }, node.path);
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: tree.map((node) => renderNode(node)) });
}
function FileContent({ files, owner, repo }) {
...
\`\`\``;
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: copyToClipboard, children: "コピー" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("pre", { style: { whiteSpace: "pre-wrap" }, children: content })
  ] });
}
...
function App() {
  ...
  if (!owner || !repo) {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { padding: 20 }, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { children: "GitHub Markdown連結ビューアA" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "URLに repo パラメータを指定してください" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("pre", { children: `?repo=owner/repository
...
?repo=facebook/react` })
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { padding: 20 }, children: [
    ...
    selectedFiles.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx(FileContent, { owner, repo, files: selectedFiles })
  ] });
}
const scriptRel = "modulepreload";
const assetsURL = function(dep) {
  return "/CopyGithubFile2MD/" + dep;
};
const seen = {};
  ...
  async function register() {
    if ("serviceWorker" in navigator) {
      wb = await __vitePreload(async () => {
        const { Workbox } = await import("./workbox-window.prod.es5-rIX2nHU4.js");
        return { Workbox };
      }, true ? [] : void 0).then(({ Workbox }) => {
        return new Workbox("/CopyGithubFile2MD/sw.js", { scope: "/CopyGithubFile2MD/", type: "classic" });
      }).catch((e) => {
        onRegisterError?.(e);
        return void 0;
      });
      ...
      wb.register({ immediate }).then((r) => {
        if (onRegisteredSW)
          onRegisteredSW("/CopyGithubFile2MD/sw.js", r);
        else
          onRegistered?.(r);
      }).catch((e) => {
        onRegisterError?.(e);
