...
function FileTree({ owner, repo, onSelect }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: files.map((file) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
...
function App() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { children: "GitHub Markdown連結ビューア" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      FileTree,
      {
        owner,
